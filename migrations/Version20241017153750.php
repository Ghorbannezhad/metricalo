...
final class Version20241017153750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN symfony_demo_comment.published_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('COMMENT ON COLUMN symfony_demo_post.published_at IS \'(DC2Type:datetime_immutable)\'');
